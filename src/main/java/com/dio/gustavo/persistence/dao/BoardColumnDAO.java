...
import com.dio.gustavo.dto.BoardColumnDTO;
...
import static com.dio.gustavo.persistence.entity.BoardColumnKindEnum.findByName;
        ...
        try(var statement = connection.prepareStatement(sql)){
            ...
            if (resultSet.next()){
                ...
                do {
                    ...
                    card.setId(resultSet.getLong("c.id"));                    card.setTitle(resultSet.getString("c.title"));
